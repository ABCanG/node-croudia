...
function Croudia(options) {
  ...
  var defaults = {
    ...
    access_token: '6bfcae19217f7d283409c80c7bb02d21ae061ff1c162d5742f5e627c9100a27c', //FIXME 取得方法を検討する
...
Croudia.prototype.get = function(url, params, callback) {
  ...
  this.oauth.get(url + '?' + querystring.stringify(params), this.options.access_token, //FIXME access_tokenの取得方法
...
Croudia.prototype.getFriendsTimeline = function(params, callback) {
...
Croudia.prototype.lookupUser
  = Croudia.prototype.lookupUsers
  = Croudia.prototype.showUser;
...
Croudia.prototype.getDirectMessages = function(params, callback) {
  var url = '/direct_messages.json';
  this.get(url, params, callback);
  return this;
};

Croudia.prototype.getDirectMessagesSent = function(params, callback) {
  var url = '/direct_messages/sent.json';
  this.get(url, params, callback);
  return this;
};
Croudia.prototype.getSentDirectMessages
  = Croudia.prototype.getDirectMessagesSent;

Croudia.prototype.newDirectMessage = function(id, text, params, callback) {
  if (typeof params === 'function') {
    callback = params;
    params = null;
  }
...
Croudia.prototype.updateDirectMessage
  = Croudia.prototype.sendDirectMessage
  = Croudia.prototype.newDirectMessage;

Croudia.prototype.destroyDirectMessage = function(id, callback) {
  var url = '/direct_messages/destroy/' + escape(id) + '.json?_method=DELETE';
  this.post(url, null, callback);
  return this;
};
Croudia.prototype.deleteDirectMessage
  = Croudia.prototype.destroyDirectMessage;
...
Croudia.prototype.updateProfileImg = function (params, callback) {
  // params: name, url, location, description
  var defaults = {
    include_entities: 1
  };
