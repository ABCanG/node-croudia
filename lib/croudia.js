...
Croudia.prototype.post = function(url, content, content_type, callback) {
  ...
  function(error, data, response) {
    if ( error && error.statusCode === 401) { //Unauthorized
      self.refresh(function() { //refresh access_token
        self.post(url, content, content_type, callback);
      });
    } else if ( error && error.statusCode ) {
      var err = new Error('HTTP Error '
        + error.statusCode + ': '
...
/**
 * @callback Croudia~statusListCallback
 * @param {Object} err Error object
 * @param {Array} statusList Status List
 */

/**
 * @callback Croudia~statusCallback
 * @param {Object} err Error object
 * @param {Object} status Status object
 */

/**
 * @callback Croudia~secretmailListCallback
 * @param {Object} err Error object
 * @param {Array} secretmailList Secretmail List
 */

/**
 * @callback Croudia~secretmailCallback
 * @param {Object} err Error object
 * @param {Object} secretmail Secretmail object
 */

/**
 * @callback Croudia~userCallback
 * @param {Object} err Error object
 * @param {Object} user User object
 */

/**
 * @callback Croudia~userListCallback
 * @param {Object} err Error object
 * @param {Array} userList User list
 */

/**
 * @callback Croudia~friendshipCallback
 * @param {Object} err Error object
 * @param {Object} friendship Friendship object
 */

/**
 * @callback Croudia~idListCallback
 * @param {Object} err Error object
 * @param {Array} idList Id list
 */

/**
 * @callback Croudia~searchMetaDataListAndStatusListCallback
 * @param {Object} err Error object
 * @param {Object} searchMetaDataListAndStatusList Search meta data list and status list object
 */
